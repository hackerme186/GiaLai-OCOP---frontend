...
export default function CheckoutModal({
  ...
  const [paymentMethod, setPaymentMethod] = useState<"COD" | "BankTransfer">(
    "COD"
  );
  ...
  const handleGetCurrentLocation = async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Không thể lấy địa chỉ từ GPS"
      );
    } finally {
    ...
    try {
      ...
      if (addressToSave && currentUser) {
        try {
          ...
          console.debug(
            "⚠️ Không thể lưu địa chỉ vào profile (đơn hàng đã được tạo thành công):",
            err
          );
        }
      }
      ...
      // Chuẩn hóa lỗi 500 chung chung từ backend
      const finalMessage =
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="ml-4 flex-1">
                      ...
                      <p className="text-sm text-gray-500 mt-1.5 ml-[3.25rem]">
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setPaymentMethod(e.target.value as "BankTransfer")
                      }
                      className="mt-1 w-5 h-5 text-indigo-600 focus:ring-indigo-500 focus:ring-2"
                      disabled={isSubmitting}
                    />
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <label
                    ...
                    className="block text-base font-bold text-gray-900 flex items-center gap-2"
                  >
                    <svg
                      className="w-5 h-5 text-indigo-600"
                      fill="none"
