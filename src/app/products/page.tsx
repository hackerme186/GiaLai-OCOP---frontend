          ...
          <div className="flex items-center space-x-6 mb-8">
            <form onSubmit={handleSearch} className="relative flex-1 max-w-2xl">
              <input
                ...
                className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder:text-gray-400"
